					 ...
					 <div class="panel-body">
					 	<div class="embed-responsive embed-responsive-16by9">
							<?php if(!empty($channel)):?>
								<video id=video   class="video-js vjs-default-skin" poster="<?php echo '../hls/'."{$channel['username']}"?>_src.png"  height=600 controls>
										  <source
											 src="<?php echo "http://140.115.153.211/hls/output/{$channel['username']}.m3u8"?>"
